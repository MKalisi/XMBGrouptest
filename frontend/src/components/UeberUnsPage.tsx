  ...
  return (
    <div className="bg-white text-slate-900 min-h-screen">
      ...
      <section className="relative overflow-hidden px-4 sm:px-6 py-20 md:py-28">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-br from-[#B84DD4] via-[#B84DD4] to-[#FDF5FA] opacity-40"></div>
      ...
      <section className="px-4 sm:px-6 py-16 sm:py-20 bg-white overflow-x-hidden">
        <div className="w-full px-2 sm:px-4 md:px-8 lg:px-12 xl:px-16">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold mb-10 sm:mb-12 md:mb-16 text-center relative inline-block group max-w-[95vw] sm:max-w-[90vw] mx-auto px-2 leading-snug">
            ...
            <span className="absolute -bottom-4 left-1/2 transform -translate-x-1/2 w-0 h-0.5 bg-gradient-to-r from-[#B84DD4] to-[#FDF5FA] group-hover:w-32 transition-all duration-500"></span>
            <span className="absolute inset-0 bg-gradient-to-r from-[#B84DD4]/0 via-[#FDF5FA]/10 to-[#B84DD4]/0 blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></span>
              </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-start">
            ...
            <svg className="absolute top-0 left-0 w-full pointer-events-none hidden sm:block" style={{ height: 'calc(100% + 80px)', zIndex: 0, overflow: 'visible' }}>
              <defs>
                <linearGradient id="lineGradient" x1="0%" y1="0%" x2="100%" y2="100%">
                  ...
                  <stop offset="50%" stopColor="#FDF5FA" stopOpacity="0.7" />
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 group">
              <div className="relative w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 lg:w-56 lg:h-56 rounded-full bg-gradient-to-br from-[#B84DD4] to-[#FDF5FA] flex items-center justify-center shadow-2xl transform transition-all duration-500 group-hover:scale-110 group-hover:shadow-[0_0_60px_rgba(146,27,178,0.5)]">
            ...
            <div className="absolute top-0 left-0 sm:left-[2%] md:left-[5%] group cursor-pointer" style={{ zIndex: 10 }}>
              <div className="relative bg-white rounded-2xl p-3 sm:p-4 md:p-6 shadow-xl border-2 border-transparent group-hover:border-[#921bb2] transform transition-all duration-500 group-hover:scale-110 group-hover:shadow-2xl w-36 sm:w-44 md:w-56 lg:w-64">
                <div className="absolute -bottom-2 -right-2 w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-full bg-gradient-to-br from-[#B84DD4] to-[#FDF5FA] flex items-center justify-center shadow-lg transform group-hover:rotate-12 transition-transform duration-300">
            ...
            <div className="lg:sticky lg:top-24 mt-6 sm:mt-8 lg:mt-0 order-2 lg:order-1">
              <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mb-6 sm:mb-8 md:mb-12 relative inline-block group leading-snug">
                ...
                <span className="absolute -bottom-2 left-0 w-0 h-0.5 bg-gradient-to-r from-[#B84DD4] to-[#FDF5FA] group-hover:w-full transition-all duration-500"></span>
              </h3>
              
              {/* Timeline Container */}
              <div className="relative">
                {/* Vertical Line */}
                <div className="absolute left-20 sm:left-24 md:left-28 lg:left-32 xl:left-36 top-0 bottom-6 w-0.5 bg-gradient-to-b from-[#B84DD4]/20 via-[#FDF5FA]/40 to-[#B84DD4]/20" style={{ transform: 'translateX(-50%)' }}></div>
                    ...
                    return (
                      <div key={index} className="relative flex items-center gap-3 sm:gap-4 md:gap-6 lg:gap-8">
                        ...
                        <div className="w-12 sm:w-14 md:w-16 lg:w-20 flex-shrink-0 text-right z-10 relative">
                          <div className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold bg-gradient-to-r from-[#B84DD4] to-[#FDF5FA] bg-clip-text text-transparent">
                            {item.year}
                          </div>
                        </div>
                        ...
                        <div className="absolute left-20 sm:left-24 md:left-28 lg:left-32 xl:left-36 z-20 flex-shrink-0" style={{ transform: 'translateX(-50%)' }}>
                          <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 lg:w-16 lg:h-16 rounded-full bg-gradient-to-br from-[#B84DD4] to-[#FDF5FA] border-2 sm:border-3 md:border-4 border-white shadow-lg flex items-center justify-center group hover:scale-110 transition-all duration-300">
            ...
            {milestones.map((milestone, index) => (
              ...
              >
                <div className="flex items-start gap-3 sm:gap-4">
                  <div className="w-2.5 h-2.5 sm:w-3 sm:h-3 rounded-full mt-1.5 sm:mt-2 flex-shrink-0 bg-gradient-to-br from-[#B84DD4] to-[#FDF5FA]"></div>
      ...
      <section className="px-4 sm:px-6 py-16 sm:py-20 bg-white">
        <div className="w-full px-2 sm:px-4 md:px-8 lg:px-12 xl:px-16">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-6 sm:mb-8 bg-gradient-to-r from-[#B84DD4] via-[#FDF5FA] to-[#B84DD4] bg-clip-text text-transparent leading-snug">Antrieb und Ziele</h2>
                ...
                >
                  <div className="relative z-10">
                    ...
                    <div className="mb-4 sm:mb-5 md:mb-6 flex justify-center">
                      <div className="w-16 h-16 sm:w-18 sm:h-18 md:w-20 md:h-20 rounded-full bg-gradient-to-br from-[#B84DD4] to-[#FDF5FA] flex items-center justify-center shadow-lg border-2 sm:border-3 md:border-4 border-white">
