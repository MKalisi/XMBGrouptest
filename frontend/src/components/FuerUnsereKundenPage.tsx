...
export function FuerUnsereKundenPage() {
  ...
  return (
    <div className="bg-white text-slate-900">
      <section className="bg-gradient-to-br from-[#921bb2] to-[#cd20b2] py-16 md:py-20 text-white">
      ...
      <section className="bg-white py-12 lg:py-16">
        <div className="max-w-3xl mx-auto px-6 md:px-8 text-center">
          ...
          <a
            href="#/kontakt"
            className="inline-block px-6 py-3 bg-gradient-to-r from-[#921bb2] to-[#cd20b2] text-white font-medium rounded-lg hover:opacity-90 transition-opacity"
          >
            Kontakt aufnehmen
          </a>
        </div>
