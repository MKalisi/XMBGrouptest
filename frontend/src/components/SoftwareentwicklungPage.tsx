            ...
            <div className="space-y-4">
              {processSteps.map((step, index) => (
                <div key={index} className="flex gap-4 bg-slate-50 rounded-lg p-5">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#921bb2] to-[#cd20b2] text-white flex items-center justify-center text-sm font-semibold flex-shrink-0">
                    {step.number}
                  </div>
                  <div>
