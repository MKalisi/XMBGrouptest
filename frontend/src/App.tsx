        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          <div className={`grid grid-cols-1 lg:grid-cols-2 ${isMobile ? 'gap-8' : 'gap-12'}`}>
            <div className="text-black space-y-4">
              <p className="uppercase tracking-wider text-sm text-black/80 font-medium">IT-Beratung</p>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-8">
          <div className={`grid grid-cols-1 lg:grid-cols-2 items-start ${isMobile ? 'gap-8' : 'gap-12'}`}>
            <div className="text-black space-y-6">
              <p className="uppercase tracking-wider text-sm text-black/80 font-medium">Kontakt</p>
              ...
              <div className="space-y-4 pt-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-sm text-black/70">E-Mail</p>
                    <p className="text-black">info@xmb-group.ch</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-sm text-black/70">Telefon</p>
                    <p className="text-black">+41 44 123 45 67</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-sm text-black/70">Adresse</p>
                    <p className="text-black">Eichengasse 3, 4702 Oensingen</p>
                  </div>
                </div>
              </div>
